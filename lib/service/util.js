...
const serviceLoader = (type = null, options = {}) => {
  ...
  // TODO: Right now, there is one level of inheritance allowed
  // (e.g. different families of controllers like api, web, cli).
  // it'd be cool to make this system more robust yet intuitive,
  // but don't know if it's necessary.
